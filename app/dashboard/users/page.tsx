          ...
          <TableRow key={user.id}>
            ...
            <TableCell>
              {user.isActive ? (
                <Badge
                  variant="outline"
                  className="text-green-600 border-green-200 bg-green-50 flex w-fit items-center gap-1"
                >
                ...
                <Badge
                  variant="outline"
                  className="text-red-600 border-red-200 bg-red-50 flex w-fit items-center gap-1"
                >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            View and manage platform users, roles, and status.
          </p>
        </div>
          ...
          <Dialog open={isAddUserOpen} onOpenChange={setIsAddUserOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a new user account here. Password will be set to
                  default "123".
                </DialogDescription>
              </DialogHeader>
