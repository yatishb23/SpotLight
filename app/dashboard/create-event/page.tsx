      ...
      <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-neutral-500 font-light italic leading-relaxed max-w-lg">
                Initialize a new event record in the global distribution ledger.
                All parameters are cryptographically logged.
              </p>
            </div>
          </div>
        </header>
            ...
            <div className="lg:col-span-8 space-y-12">
              ...
              <section className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-[10px] uppercase tracking-[0.4em] text-neutral-400 font-black">
                    Visual Identity
                  </h2>
                </div>
                      ...
                      <div className="h-72 flex flex-col items-center justify-center gap-4 text-neutral-600 group-hover:text-neutral-400 transition-colors">
                        ...
                        <div className="text-center">
                          <p className="text-[10px] uppercase tracking-widest font-black">
                            Upload Protocol Banner
                          </p>
                          <p className="text-[9px] mt-1 opacity-50 font-mono">
                            1200 x 630 recommended // JPG, PNG
                          </p>
                        </div>
                      </div>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="space-y-3">
                        <FormLabel className="text-[9px] uppercase tracking-widest text-neutral-500 font-bold">
                          Event Designation
                        </FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                            placeholder="e.g., TECH_SUMMIT_2026"
                            className="bg-neutral-900/50 border-neutral-800 rounded-xl h-12 focus:ring-0 focus:border-neutral-600 text-sm"
                          />
                        </FormControl>
                    ...
                    render={({ field }) => (
                      <FormItem className="space-y-3">
                        ...
                        <FormControl>
                          <Textarea
                            {...field}
                            placeholder="Detailed protocol abstract..."
                            className="bg-neutral-900/50 border-neutral-800 rounded-xl min-h-[150px] focus:ring-0 focus:border-neutral-600 text-sm leading-relaxed"
                          />
                        </FormControl>
                        <FormMessage className="text-[10px] font-mono text-red-500" />
                      </FormItem>
                        ...
                        <FormItem className="space-y-3">
                          ...
                          <FormControl>
                            <Input
                              ...
                              className="bg-neutral-900/50 border-neutral-800 rounded-xl h-12 text-sm"
                            />
                          </FormControl>
                        </FormItem>
                      )}
                        ...
                        <FormItem className="space-y-3">
                          ...
                          <FormControl>
                            <Input
                              type="date"
                              {...field}
                              className="bg-neutral-900/50 border-neutral-800 rounded-xl h-12 text-sm text-neutral-400"
                            />
                          </FormControl>
                        </FormItem>
                      )}
                        ...
                        <FormItem className="space-y-3">
                          ...
                          <FormControl>
                            <Input
                              type="number"
                              {...field}
                              className="bg-neutral-900/50 border-neutral-800 rounded-xl h-12"
                            />
                          </FormControl>
                        </FormItem>
                      )}
                ...
                <div className="p-8 rounded-[32px] bg-neutral-900/20 border border-neutral-900 space-y-8 backdrop-blur-xl">
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-2xl bg-neutral-950/50 border border-neutral-900">
                    ...
                    <p className="text-[10px] leading-relaxed text-neutral-500 uppercase font-bold tracking-tight">
                      Compliance verified via AES-256 encrypted tunnel. Hub
                      Registry node: INTEL_CORE_09.
                    </p>
                  </div>
                </div>
              </aside>
        ...
        <footer className="pt-10 border-t border-neutral-900 opacity-20 flex justify-between items-center">
          <p className="text-[9px] font-mono uppercase tracking-widest text-neutral-500 flex items-center gap-2">
            <ShieldCheck className="w-3 h-3" /> HUB_PROTOCOL_V2 //
            SESSION_ENCRYPTED
          </p>
  ...
  return (
    <div className="flex gap-4 group">
      ...
      <div className="space-y-1">
        <p className="text-[10px] uppercase tracking-widest text-neutral-300 font-black">
          {title}
        </p>
