  ...
  return (
    <div className="min-h-screen bg-[#050505] text-neutral-200 selection:bg-neutral-800 py-16 px-6 lg:px-12">
      <div className="max-w-7xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        {/* Header Ledger */}
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/[0.04] pb-10">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-2 py-1 rounded bg-white/[0.04] border border-white/[0.04] mb-2">
        ...
        {loading ? (
          ...
          <div className="py-32 text-center bg-white/[0.02] border border-dashed border-white/[0.04] rounded-[40px]">
            <div className="w-16 h-16 bg-white/[0.04] rounded-full flex items-center justify-center mx-auto mb-6 border border-white/[0.04]">
            ...
            <Button
              className="bg-white text-black hover:bg-neutral-200 rounded-2xl font-black uppercase tracking-widest text-[10px] h-12 px-8"
              asChild
            >
              <Link href="/">
                Clear Parameters <ArrowRight className="w-3 h-3 ml-2" />
              </Link>
            </Button>
          </div>
        ) : (
